...
class DetailKegiatanRtModal extends StatefulWidget {
  final Kegiatan kegiatan;
  final bool readonly;

  const DetailKegiatanRtModal({
    super.key,
  ...
  @override
  State<DetailKegiatanRtModal> createState() => _DetailKegiatanRtModalState();
}

class _DetailKegiatanRtModalState extends State<DetailKegiatanRtModal> {
  ...
  Widget build(BuildContext context) {
    final vm = context.watch<KegiatanRtViewModel>();
