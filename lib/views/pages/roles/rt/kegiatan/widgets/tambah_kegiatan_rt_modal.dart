...
class TambahKegiatanRtModal extends StatefulWidget {
  const TambahKegiatanRtModal({super.key});

  @override
  State<TambahKegiatanRtModal> createState() => _TambahKegiatanRtModalState();
}

class _TambahKegiatanRtModalState extends State<TambahKegiatanRtModal> {
  ...
  Widget build(BuildContext context) {
    final vm = context.read<KegiatanRtViewModel>();
  ...
  Widget _documentBox(KegiatanRtViewModel vm) {
    final fileName =
  ...
  Widget _imageBox(KegiatanRtViewModel vm) {
    return GestureDetector(
