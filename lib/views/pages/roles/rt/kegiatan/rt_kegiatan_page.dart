...
import 'package:rukun_app_proyek4/views/pages/roles/rt/kegiatan/widgets/detail_kegiatan_rt_modal.dart';
import 'package:rukun_app_proyek4/views/pages/roles/rt/kegiatan/widgets/tambah_kegiatan_rt_modal.dart';

class RtKegiatanPage extends StatelessWidget {
  const RtKegiatanPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<KegiatanRtViewModel>(
  ...
  Widget _buildSearch(KegiatanRtViewModel vm) {
    return Padding(
  ...
  Widget _headerKegiatan(BuildContext context, KegiatanRtViewModel vm) {
    return Padding(
      ...
      child: Row(
        children: [
          ...
          if (vm.selectedLevel == KegiatanLevel.rt)
            ElevatedButton(
              onPressed: () {
                _openCreate(context);
              },
  ...
  Widget _summary(KegiatanRtViewModel vm) {
    return Padding(
  ...
  Widget _levelSwitcher(KegiatanRtViewModel vm) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 16),
  ...
  Widget _statusFilter(KegiatanRtViewModel vm) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 16),
    ...
    showModalBottomSheet(
      ...
      builder: (_) {
        return FractionallySizedBox(
          ...
          child: DetailKegiatanRtModal(kegiatan: kegiatan, readonly: readonly),
        );
      },
    );
  }
